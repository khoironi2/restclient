								...
								<div class="main-left-sidebar no-margin">
									<div class="user-data full-width">
										<div class="user-profile">
											<div class="username-dt">
												<div class="usr-pic">
													<img src="<?php echo base_url('assets/images/resources/user-pic.png') ?>" alt="">
												</div>
											</div><!--username-dt end-->
									...
									<div class="suggestions full-width">
										...
										<div class="suggestions-list">
											...
											<div class="suggestion-usd">
												<img src="<?php echo base_url('assets/images/resources/s2.png') ?>" alt="">
												<div class="sgt-text">
													<h4>John Doe</h4>
											...
											<div class="suggestion-usd">
												<img src="<?php echo base_url('assets/images/resources/s3.png') ?>" alt="">
												<div class="sgt-text">
													<h4>Poonam</h4>
											...
											<div class="suggestion-usd">
												<img src="<?php echo base_url('assets/images/resources/s4.png') ?>" alt="">
												<div class="sgt-text">
													<h4>Bill Gates</h4>
											...
											<div class="suggestion-usd">
												<img src="<?php echo base_url('assets/images/resources/s5.png') ?>" alt="">
												<div class="sgt-text">
													<h4>Jessica William</h4>
													<span>Graphic Designer</span>
												</div>
											...
											<div class="suggestion-usd">
												<img src="<?php echo base_url('assets/images/resources/s6.png') ?>" alt="">
												<div class="sgt-text">
													<h4>John Doe</h4>
													<span>PHP Developer</span>
												</div>
									...
									<div class="posts-section">
										<div class="post-bar">
											<div class="post_topbar">
												<div class="usy-dt">
													<img src="<?php echo base_url('assets/images/resources/us-pic.png') ?>" alt="">
													<div class="usy-name">
														<h3>John Doe</h3>
